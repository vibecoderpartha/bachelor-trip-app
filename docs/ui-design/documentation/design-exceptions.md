...
Mirror of `manifests/exception-register.md`. Resolved exceptions are never deleted — the decision is recorded against them.

All sixteen exceptions (E-01…E-16) are decided. None is awaiting approval. Batches 7 and 8 raised no new exception.
